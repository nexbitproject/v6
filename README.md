...
Nexbit is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
completely stable. [Tags](https://gitlab.com/nexbit/nexbit/tags) are created
regularly to indicate new official, stable release versions of Nexbit.
