    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextNexbit   = QChar(0xA9)+QString(" %1-%2 ").arg(2018).arg(COPYRIGHT_YEAR) + QString("The Nexbit developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+20,copyrightTextNexbit);
    }
